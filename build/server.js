...
var _ref = _jsx('h1', {}, void 0, 'Search Results: ');
...
class Layout extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
  ...
  callApi() {
    ...
    return _asyncToGenerator(function* () {
      try {
        let response = yield fetch('https://api.github.com/search/repositories?q=' + _this.state.keyWord + '&sort=forks&order=desc', {
          method: 'GET',
          headers: {
        ...
        if (response.status == 200) {
          _this.setState({ searchResults: responseJson.items });
        } else {
  ...
  render() {
    return _jsx('div', {}, void 0, 'Enter KeyWord to search most active Git Repositories: ', _jsx('input', {
      placeholder: 'Enter Key Word',
      type: 'text',
      value: this.state.keyWord,
      onChange: this.keyPressed
    }), _ref, this.state.searchResults.map((item, n) => {
      return _jsx('div', {
        style: { marginLeft: 25 }
      }, n, _jsx('a', {
        target: '_blank',
        href: item.url
      }, void 0, _jsx('h3', {}, void 0, item.full_name)), _jsx('p', {}, void 0, 'Name: ', item.name), _jsx('p', {}, void 0, 'Clone Url: ', item.clone_url), _jsx('p', {}, void 0, 'Description: ', item.description), _jsx('p', {}, void 0, 'Number Of Forks: ', item.forks_count));
    }));
  }
}
...
/* unused harmony default export */ var _unused_webpack_default_export = __WEBPACK_IMPORTED_MODULE_1_isomorphic_style_loader_lib_withStyles___default()(__WEBPACK_IMPORTED_MODULE_2__Header_css___default.a)(Header);
...
function Html(props) {
  ...
  }), __WEBPACK_IMPORTED_MODULE_1__config__["d" /* analytics */].google.trackingId && _ref5));
}
...
function Home(props) {
  return _jsx('div', {
    ...
    className: __WEBPACK_IMPORTED_MODULE_2__Home_css___default.a.newsItem
  }, item.link, _jsx('h1', {
    className: __WEBPACK_IMPORTED_MODULE_2__Home_css___default.a.newsTitle
  }, void 0, _jsx('a', {
    href: item.link
